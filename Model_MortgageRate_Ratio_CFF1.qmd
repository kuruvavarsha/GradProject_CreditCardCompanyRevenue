---
title: "Mortgage Rate- Ratio - CFF1"
...
CFF_1_Ratio_Mortgage<-merge(CFF_1_agg_ratio,mortgage_rate, by ="Date")
head(CFF_1_Ratio_Mortgage)
write.csv(CFF_1_Ratio_Mortgage,"CFF_1_Ratio_Mortgage.csv")
...
#| include: false
# Reading data
data <- fread("CFF_1_Ratio_Mortgage.csv", header = T, fill = TRUE)
#head(data)
summary(data)
...
Unemployment rate follows an decreasing curve after the initial high in 2008.
...
***Therefore, we can conclude that*** because of the high p-value of the Anova test between model 1 and 2, we can conclude that Mortgage Rate does not Granger-cause Revenue.
