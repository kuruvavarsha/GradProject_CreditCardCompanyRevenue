---
title: "Purchase Index - Revenue - CFF1"
author: "UC Team"
format: html
editor: visual
---
...
CFF_1_Revenue_purchase<-merge(CFF_1_agg_revenue,Purchase_index, by ="Date")
CFF_1_Revenue_purchase
write.csv(CFF_1_Revenue_purchase,"CFF_1_Revenue_purchase.csv")
```
...
#| include: false
# Reading data
data <- fread("CFF_1_Revenue_Purchase.csv", header = T, fill = TRUE)
#head(data)
#summary(data)
...
Therefore, we can infer that including ***dx*** in the model **does not significantly improve the prediction** of ***dy***, and that Model 2 is a better choice.
