---
title: "Unemployment Rate-Revenue -  CFF1 "
...
library("writexl")
  ...
  CFF_1_Unrate_revenue<-merge(CFF_1_agg_revenue,unemployment_rate, by ="Date")
  CFF_1_Unrate_revenue
  #write.csv(CFF_1_Unrate_revenue,"CFF_1_Revenue_Unrate.csv")
```
...
# Reading data
data <- read.csv("CFF_1_Revenue_Unrate.csv", header = T, fill = TRUE)
#head(data)
summary(data)
...
The Revenue plot has a lot of fluctuations in the time series plot with a peak right before the start of the year 2012.
