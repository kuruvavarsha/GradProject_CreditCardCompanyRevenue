---
title: "Model for Purchase Index - Ratio - CFF5"
author: "UC Team"
format: html
editor: visual
---
...
CFF_5_Ratio_Purchase<-merge(CFF_5_agg_ratio,Purchase_index, by ="Date")

write.csv(CFF_5_Ratio_Purchase,"CFF_5_Ratio_Purchase.csv")
head(CFF_5_Ratio_Purchase)
```
...
#| include: false
# Reading data
data <- fread("CFF_5_Ratio_Purchase.csv", header = T, fill = TRUE)
#head(data)
#summary(data)
