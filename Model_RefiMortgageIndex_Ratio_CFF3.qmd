---
title: "Refi Index vs Ratio CFF 3"
author: "UC Team"
format: html
editor: visual
---
...
CFF_3_refi_ratio <- merge(CFF_3_agg_ratio,refi_rate , by = "Date")
CFF_3_refi_ratio
write.csv(CFF_3_refi_ratio,"CFF_3_refi_ratio.csv")
...
#| include: false
# Reading data
data <- fread("CFF_3_refi_ratio.csv", header = T, fill = TRUE)
...
It can be concluded that ***Refinance Index granger causes ratio of actuals to predicted.***

**xh3 is statistically significant**.

For every unit increase in **xh3**, the response variable that is **Ratio** **is estimated to increase by** **0.21997** **units**, holding other predictors constant.
