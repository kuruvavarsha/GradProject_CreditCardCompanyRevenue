---
title: "Mortgage Rate- Ratio - CFF3"
...
CFF_3_Ratio_Mortgage<-merge(CFF_3_agg_ratio,mortgage_rate, by ="Date")
head(CFF_3_Ratio_Mortgage)
#write.csv(CFF_3_Ratio_Mortgage,"CFF_3_Ratio_Mortgage.csv")
...
# Reading data
data <- fread("CFF_3_Ratio_Mortgage.csv", header = T, fill = TRUE)
#head(data)
summary(data)
...
For every unit increase in **xh3**, the response variable that is Ratio **is estimated to decrease by 1.51028** **units**, holding other predictors constant.

For every unit increase in **xh4**, the response variable that is **Ratio is estimated to increase by** 1.02075 **units**, holding other predictors constant.
...
effect1 = (-1.51028*(log(4) - log(3.5)))+( 1.02075*(log(3.5)-log(3)))
...
*For every unit increase in Mortgage Rate , ratio will decrease by 0.04 units.*
