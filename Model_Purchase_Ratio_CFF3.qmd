---
title: "Model for Purchase Index - Ratio - CFF3"
author: "UC Team"
format: html
editor: visual
---
...
CFF_3_Ratio_Purchase<-merge(CFF_3_agg_ratio,Purchase_index, by ="Date")

#write.csv(CFF_3_Ratio_Purchase,"CFF_3_Ratio_Purchase.csv")
head(CFF_3_Ratio_Purchase)
```
...
#| include: false
# Reading data
data <- fread("CFF_3_Ratio_Purchase.csv", header = T, fill = TRUE)
#head(data)
#summary(data)
