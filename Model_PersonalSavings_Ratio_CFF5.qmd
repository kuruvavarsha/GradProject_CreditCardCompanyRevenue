---
title: "Personal Savings Rate vs Ratio CFF 5"
author: "UC Team"
format: html
editor: visual
---
...
CFF_5_Savings_ratio <- merge(CFF_5_agg_ratio,Savings , by = "Date")
CFF_5_Savings_ratio
write.csv(CFF_5_Savings_ratio,"CFF_5_Savings_ratio.csv")
```
...
#| include: false
# Reading data
data <- fread("CFF_5_Savings_ratio.csv", header = T, fill = TRUE)
#head(data)
#summary(data)
...
xh <- embed(data_final$value_log_diff_srate,3)
...
***Therefore, we can conclude that*** Personal Savings Rate does not granger cause Ratio.
