---
title: "Unemployment Rate - Ratio - CFF1 "
...
#write.csv(CFF_1_agg_ratio,"CFF_1_agg_ratio.csv")
  ...
  CFF_1_Unrate_ratio<-merge(CFF_1_agg_ratio,unemployment_rate, by ="Date")
  CFF_1_Unrate_ratio
  #write.csv(CFF_1_Unrate_ratio,"CFF_1_Ratio_Unrate.csv")
```
...
#| include: false
# Reading data
data <- fread("CFF_1_Ratio_Unrate.csv", header = T, fill = TRUE)
head(data)
summary(data)
...
Unemployment rate follows an increasing curve after the initial dip due to recession in 2008.
...
***Therefore, we can conclude that*** because of the high p-value of the Anova test between model 1 and 2, we can conclude that Unemployment Rate does not Granger-cause Ratio.
