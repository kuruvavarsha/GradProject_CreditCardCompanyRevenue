---
title: "Unemployment Rate - Ratio - CFF5 "
...
#write.csv(CFF_1_agg_ratio,"CFF_1_agg_ratio.csv")
  ...
  CFF_5_Unrate_ratio<-merge(CFF_5_agg_ratio,unemployment_rate, by ="Date")
  CFF_5_Unrate_ratio
  write.csv(CFF_5_Unrate_ratio,"CFF_5_Ratio_Unrate.csv")
```
...
#| include: false
# Reading data
data <- fread("CFF_5_Ratio_Unrate.csv", header = T, fill = TRUE)
head(data)
summary(data)
...
The ratio plot has a lot of fluctuations in the time series plot with a steep dip after 2020
...
Unemployment rate follows a decreasing curve .
...
xh <- embed(data_final$value_log_diff_unemp,3)
...
***Therefore, we can conclude that*** Unemployment Rate does not Granger-cause Ratio.
