---
title: "Interest Rate vs Ratio - CFF5"
author: "UC Team"
format: html
editor: visual
---
...
CFF_5_Interest_ratio <- merge(CFF_5_agg_ratio,interest, by = "Date")
CFF_5_Interest_ratio
write.csv(CFF_5_Interest_ratio,"CFF_5_Interest_ratio.csv")
...
# Reading data
data <- fread("CFF_5_Interest_ratio.csv", header = T, fill = TRUE)
...
Interest rates saw a steady incline and has increased post that.
...
***Therefore, we can conclude that*** interest rate does not granger cause Ratio.
