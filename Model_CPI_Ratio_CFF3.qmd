...
CFF_3_agg_ratio
# CFF_3_agg_ratio Final file for CFF_3 monthly aggregated data national level 


library("writexl")
#write.csv(CFF_3_agg_ratio,"CFF_3_agg_ratio.csv")
  ...
  CFF_3_Ratio_CPI<-merge(CFF_3_agg_ratio,CPI, by ="Date")
  CFF_3_Ratio_CPI
 # write.csv(CFF_3_Ratio_CPI,"CFF_3_Ratio_CPI.csv")
...
# Reading data
data <- fread("CFF_3_Ratio_CPI.csv", header = T, fill = TRUE)
#head(data)
summary(data)
...
CPI follows an increasing curve after the dip in 2015.
...
*For every unit increase in xh3, the response variable i.e Ratio of actuals to predicted is estimated to increase by 11.9098 units, holding other predictors constant.*
...
effect1 = 11.9098*(log(102.7) - log(101.7))
...
*For every one unit increase in CPI, ratio changes by 0.11 units.*
