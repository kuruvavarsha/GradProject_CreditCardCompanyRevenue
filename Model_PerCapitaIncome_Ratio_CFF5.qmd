---
title: "Per Capita Income vs Ratio CFF 5"
author: "UC Team"
format: html
editor: visual
---
...
CFF_5_Income_ratio <- merge(CFF_5_agg_ratio,income, by = "Date")
CFF_5_Income_ratio
write.csv(CFF_5_Income_ratio,"CFF_5_Income_ratio.csv")
```
...
data <- fread("CFF_5_Income_ratio.csv", header = T, fill = TRUE)
...
Per capita income follows an increasing trend .
...
***Therefore, we can conclude that*** interest rate does not granger causes ratio.
