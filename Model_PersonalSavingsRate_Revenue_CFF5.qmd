---
title: "Personal Savings Rate vs Actual Revenue -CFF5"
author: "UC Team"
format: html
editor: visual
---
...
CFF_5_Savings_revenue <- merge(CFF_5_agg_revenue,Savings , by = "Date")
CFF_5_Savings_revenue
write.csv(CFF_5_Savings_revenue  ,"CFF_5_Savings_revenue.csv")
```
...
#| include: false
# Reading data
data <- fread("CFF_5_Savings_revenue.csv", header = T, fill = TRUE)
...
Personal savings rate follows mostly an increasing trend and decreasing trend.
