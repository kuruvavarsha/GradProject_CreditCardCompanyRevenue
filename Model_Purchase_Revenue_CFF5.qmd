---
title: "Purchase Index - Revenue - CFF5"
author: "UC Team"
format: html
editor: visual
---
...
CFF_5_Revenue_purchase<-merge(CFF_5_agg_revenue,Purchase_index, by ="Date")
CFF_5_Revenue_purchase
write.csv(CFF_5_Revenue_purchase,"CFF_5_Revenue_purchase.csv")
```
...
#| include: false
# Reading data
data <- fread("CFF_5_Revenue_Purchase.csv", header = T, fill = TRUE)
#head(data)
#summary(data)
...
Purchase Index has a lot of fluctuations.
...
xh <- embed(data_final$value_log_diff_PIndex,3)
...
***But we do observe that xh5 has a p value slightly near 0.05.***
