---
title: "Mortgage Rate - Revenue - CFF5"
author: "UC Team"
format: html
editor: visual
---
...
CFF_5_Revenue_Mortgage<-merge(CFF_5_agg_revenue,mortgage_rate, by ="Date")
head(CFF_5_Revenue_Mortgage)
write.csv(CFF_5_Revenue_Mortgage,"CFF_5_Revenue_Mortgage.csv")
```
...
#| include: false
# Reading data
data <- fread("CFF_5_Revenue_Mortgage.csv", header = T, fill = TRUE)
#head(data)
#summary(data)
...
***Therefore, we can conclude that*** Mortgage does not Granger-cause Revenue.
